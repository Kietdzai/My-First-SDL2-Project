all:
	g++ main.cpp Window.cpp Questions.cpp Cursor.cpp LoadImage.cpp Game.cpp Answer.cpp Font.cpp JSONObject.cpp Button.cpp Counter.cpp Sound.cpp HealthBar.cpp \
